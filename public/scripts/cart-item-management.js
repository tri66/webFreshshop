...
const cartTotalPriceElement = document.getElementBy('card-total-price');
...
async function updateCartItem(event) {
    ...
    cartTotalPriceElement.textContent = responseData.updatedCartDta.newTotalPrice.toFixed(2);
